import type { GroupTeachersType, ModalProps, TeachersType } from "@types"
...
const AddTeacherToGroupModal = ({ open, toggle, teachers }: AddTeacherToGroupModalProps) => {
    ...
    const selectedTeachers = useMemo(() => {
        if (!allTeachers || !teachers) return [];
        const groupTeacherIds = teachers.map((teacher: any) => teacher.id);
        return allTeachers.data.filter((teacher: any) =>
            !groupTeacherIds.includes(teacher.id)
        );
